...
mod tests {
    ...
    fn insert() {
        ...
        assert_eq!(
            set,
            OrderedSet::<i32, Eight>::from(vec![].try_into().unwrap())
        );

        assert!(set.insert(1));
        assert_eq!(
            set,
            OrderedSet::<i32, Eight>::from(vec![1].try_into().unwrap())
        );

        assert!(set.insert(5));
        assert_eq!(
            set,
            OrderedSet::<i32, Eight>::from(vec![1, 5].try_into().unwrap())
        );

        assert!(set.insert(3));
        assert_eq!(
            set,
            OrderedSet::<i32, Eight>::from(vec![1, 3, 5].try_into().unwrap())
        );
    ...
    fn remove() {
        ...
        assert_eq!(
            set,
            OrderedSet::<i32, Eight>::from(vec![2, 3, 4].try_into().unwrap())
        );

        assert!(set.remove(&3));
        assert_eq!(
            set,
            OrderedSet::<i32, Eight>::from(vec![2, 4].try_into().unwrap())
        );
        ...
        assert_eq!(
            set,
            OrderedSet::<i32, Eight>::from(vec![2].try_into().unwrap())
        );
